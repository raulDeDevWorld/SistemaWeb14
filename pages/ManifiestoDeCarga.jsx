                ...
                <form className={style.form}>
                    ...
                    <div className={style.containerItems}>
                        ...
                        <div className={style.itemsThree}>
                            ...
                            <div>
                                <input type="text" onChange={handleEventChange} value='NO' placeholder='' />
                                <input type="text" name={"MANISFESTO 6"} onChange={handleEventChange} value='' placeholder='' />
                            </div>

                            <div>
                                <input type="text" name={"MANISFESTO 4"} onChange={handleEventChange} value='FECHA' placeholder='' />
                                <input type="text" name={"MANISFESTO 4"} onChange={handleEventChange} value='' placeholder='' />

                            </div>
                            <div>
                                <input type="text" name={"MANISFESTO 6"} onChange={handleEventChange} value='OPERADOR' placeholder='' />
                                <input type="text" name={"MANISFESTO 6"} onChange={handleEventChange} value='' placeholder='' />
                            </div>

                            <div>
                                <input type="text" name={"MANISFESTO 8"} onChange={handleEventChange} value='CELULAR' placeholder='' />
